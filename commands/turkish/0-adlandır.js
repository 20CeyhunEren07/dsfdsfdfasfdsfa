...
module.exports = {
  name: "adlandır",
  aliases: [], // hiçbir takma ad yoksa: []
  userPerms: "MANAGE_EMOJIS", // kullanıcı izinlerine gerek yoksa bu bölümü kaldırın.
  userPermsError: "Bu Komutu Kullanmak İçin \`Emojileri Yönet\` Yetkisine Sahip Olmalısın :warning:", // kullanıcı izinlerine gerek yoksa bu bölümü kaldırın.
